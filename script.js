$(document).ready(function () {
  ...
  let dadaSystem = {
    scadrian: {
      info: `<div class="info__main_data">
                <div class="main_data__logo_system"><img src="./img/logos/scadrian_logo.svg" alt=""></div>
    ...
    nalthian: {
      info: `<div class="info__main_data">
            <div class="main_data__logo_system"><img src="./img/logos/nalthian_logo.svg" alt=""></div>
    ...
    rosharan: {
      info: `<div class="info__main_data">
            <div class="main_data__logo_system"><img src="./img/logos/rosharan_logo.svg" alt=""></div>
    ...
    selish: {
      info: `<div class="info__main_data">
            <div class="main_data__logo_system"><img src="./img/logos/selish_logo.svg" alt=""></div>
    ...
    drominad: {
      info: `<div class="info__main_data">
            <div class="main_data__logo_system"><img src="./img/logos/drominad_logo.svg" alt=""></div>
    ...
    taldain: {
      info: `<div class="info__main_data">
            <div class="main_data__logo_system"><img src="./img/logos/taldain_logo.svg" alt=""></div>
    ...
    threnodite: {
      info: `<div class="info__main_data">
            <div class="main_data__logo_system"><img src="./img/logos/threnodite_logo.svg" alt=""></div>
  ...
  function loadConstellations(constellations) {
  ...
  $(".system .system__sun_content .sun").click(function () {
    ...
    main.css({
      //font-size: .5vmax;
      "transform-origin":
        (position.left + systemW / 2) / vmax +
        "rem " +
        (position.top + systemH / 2) / vmax +
        "rem",
    })
    ...
    info
      .empty()
      .append(
        `<div class="info_content">${dadaSystem[thisIDSystem]["info"]}</div>`
      )
  ...
  $(".system__sun_content .sun").hover(
    function () {
      ...
      $(this)
        .parents(".system")
        .find(".system__content .system__sun")
        .addClass("system__sun--hover")
    },
    function () {
      //leaves
      $(this)
        .parents(".system")
        .find(".system__content .system__sun")
        .removeClass("system__sun--hover")
    }
  )

  $("body").on(
    "click",
    ".system .system__rings_content .system__sun",
    function () {
      closeInfoBox()
    }
  )
  ...
  $(".system__planet_content").hover(
    function () {
      ...
      $(
        "#" + thisIdHover + " .system__rings_content > .system__ring_content"
      ).css("opacity", ".2")
  ...
  loadConstellations(constellations)
  loadSystems(systems)
